...
| `liquid_level_sim/scripts/real_cases.py` | First real footage: a phone photo pair (empty / filled tumbler) and a 51 s pouring video in front of a backlit checker panel, cropped to a portrait window, sampled and embedded as cases P1 / P2 (no ground truth) |
